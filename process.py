...
#    axs5.plot(xgputp_axis, TPs[1][:xgputp], 'b,', label='Chameleon')
#    axs5.plot(xgputp_axis, TPs[2][:xgputp], 'b,', label='Chameleon')
...
def main():
    ...
    gpuFiles.append(sys.argv[3])
    gpuFiles.append(sys.argv[4])

    ioFiles.append(sys.argv[5])
    ioFiles.append(sys.argv[6])
    ioFiles.append(sys.argv[7])
    ioFiles.append(sys.argv[8])

    tpFiles.append(sys.argv[9])
    tpFiles.append(sys.argv[10])
    tpFiles.append(sys.argv[11])
    tpFiles.append(sys.argv[12])
